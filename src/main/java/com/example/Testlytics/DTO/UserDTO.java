...
public class UserDTO {
    ...
    private String imageBase64; // Stores Base64 string
    ...
    // Constructor with Base64 image (for fetching a single user)
    ...
    // Convert a User entity to UserDTO with Base64 image (for fetching a single user)
